...
<script>
    ...
    $('.form-remover .btn-remover').on('click', function (event) {
        event.preventDefault();

        swal.fire({
            title: '{{trans('system.messages.are_you_sure')}}',
            text: "{!! trans('system.messages.you_cant_undo_that') !!}",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#3085d6',
            confirmButtonText: '{{trans('system.button.yes_remove')}}',
