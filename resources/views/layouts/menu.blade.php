...
{{--            <li id="menu_item_dashboard" class="kt-menu__item" aria-haspopup="true">--}}
...
{{--            </li>--}}
            ...
            <li id="menu_item_usuario" class="kt-menu__item " aria-haspopup="true">
                <a href="{{route('system.user.index')}}" class="kt-menu__link ">
                    ...
                    <span class="kt-menu__link-text">
                    @lang('movie.label.movies')
                </a>
            </li>

            <li class="kt-menu__section ">
                <h4 class="kt-menu__section-text">@lang('system.label.system')</h4>
                <i class="kt-menu__section-icon flaticon-more-v2"></i>
            </li>
